...
import cz.fit.barannil.rentalsserver.Rental;
 ...
 */
@Stateless
@Path("cz.fit.barannil.rentalsserver.rental")
public class RentalFacadeREST extends AbstractFacade<Rental> {

    @PersistenceContext(unitName = "cz.fit.barannil_RentalsServer_war_1.0-SNAPSHOTPU")
